...
Ltmp2:
	...
	movq	-16(%rbx), %rdi
	movq	-8(%rbx), %rsi
	callq	__ZN5alloc5alloc8box_free17h29da4fd65aca6089E
	testq	%r12, %r12
	je	LBB9_16
	.p2align	4, 0x90
LBB9_12:
Ltmp3:
	movq	%rbx, %rdi
	callq	__ZN4core3ptr13drop_in_place17hc88a553504022e41E
Ltmp4:
	addq	$16, %rbx
	addq	$-16, %r12
	jne	LBB9_12
...
LBB9_16:
	movq	(%r14), %rdi
	movq	8(%r14), %rsi
	callq	__ZN4core3ptr13drop_in_place17hd5a2ebb0575069efE
	movq	%r15, %rdi
...
Ltmp8:
	leaq	-160(%rbp), %rdi
	leaq	-112(%rbp), %rsi
	callq	__ZN112_$LT$alloc..collections..btree..map..IntoIter$LT$K$C$V$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17hdb4a8937016001aaE
Ltmp9:
	movq	-160(%rbp), %rdi
	testq	%rdi, %rdi
	je	LBB11_50
...
LBB11_30:
	leaq	112(%r14), %rdi
Ltmp14:
	callq	__ZN4core3ptr13drop_in_place17h68dec94ea177bc52E
Ltmp15:
	cmpl	$3, 152(%r14)
	jne	LBB11_23
	leaq	156(%r14), %rdi
...
LBB11_59:
	...
	retq
LBB11_33:
	leaq	__ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17hf064ee018a8f9f12E(%rip), %rax
	vmovq	%rax, %xmm0
...
LBB11_55:
	movq	%rax, %rbx
	leaq	96(%r14), %rdi
	callq	__ZN4core3ptr13drop_in_place17h3dceb8b0a4ba533cE
	leaq	112(%r14), %rdi
	callq	__ZN4core3ptr13drop_in_place17h68dec94ea177bc52E
LBB11_56:
	leaq	152(%r14), %rdi
	callq	__ZN4core3ptr13drop_in_place17h2263477bdae3e572E
LBB11_19:
	leaq	160(%r14), %rdi
	callq	__ZN4core3ptr13drop_in_place17h2263477bdae3e572E
LBB11_20:
...
Ltmp27:
	...
	vmovdqu	-296(%rbp), %ymm0
	vmovups	-264(%rbp), %ymm1
	vmovups	-232(%rbp), %ymm2
	vmovups	-200(%rbp), %ymm3
...
Ltmp48:
	leaq	-576(%rbp), %rdi
	callq	__ZN4core3ptr13drop_in_place17h9ad9d2daf7a7513bE
Ltmp49:
	jmp	LBB17_23
LBB17_13:
	leaq	-376(%rbp), %rax
...
LBB17_24:
	...
	movq	$0, -296(%rbp)
	vpextrq	$1, %xmm0, -288(%rbp)
	vmovdqu	%xmm0, -280(%rbp)
	movq	$0, -264(%rbp)
	vpextrq	$1, %xmm0, -256(%rbp)
	movq	$1, -248(%rbp)
...
Ltmp38:
	leaq	-296(%rbp), %rdi
	callq	__ZN84_$LT$core..str..Split$LT$P$GT$$u20$as$u20$core..iter..traits..iterator..Iterator$GT$4next17haf26decf37fdb5f8E
Ltmp39:
	xorl	%esi, %esi
	testq	%rax, %rax
	setne	%sil
...
Ltmp47:
	...
	callq	__ZN5alloc5alloc8box_free17h29da4fd65aca6089E
	movq	%rbx, %rdi
	callq	__ZN5alloc5alloc8box_free17h579fad4c2fccfe6bE
	jmp	LBB17_46
LBB17_44:
Ltmp50:
	movq	%rax, %r14
...
Ltmp28:
	movq	%rax, %r14
	leaq	-48(%rbp), %rdi
	callq	__ZN4core3ptr13drop_in_place17h19ceedd8e1796e5eE
	movq	%r14, %rdi
	callq	__Unwind_Resume
	ud2
LBB17_42:
Ltmp44:
	movq	%rax, %r14
	leaq	-112(%rbp), %rdi
	callq	__ZN4core3ptr13drop_in_place17h78b594739553970dE
	movq	%r14, %rdi
	callq	__Unwind_Resume
	ud2
LBB17_45:
...
_main:
	...
	movq	%rsi, %rcx
	movslq	%edi, %rdx
	leaq	__ZN18build_script_build4main17hac226b899e347250E(%rip), %rax
	movq	%rax, -8(%rbp)
	leaq	l___unnamed_3(%rip), %rsi
	leaq	-8(%rbp), %rdi
	callq	__ZN3std2rt19lang_start_internal17hebefdaa8fd585aefE
